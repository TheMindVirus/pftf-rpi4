...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdUefiVariableDefaultPlatformLangCodes[6] = {101, 110, 45, 85, 83, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdUefiVariableDefaultPlatformLangCodes = 6;
  ...
  )
{
  ...
  Status = PlatformUiAppLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  Status = PlatformUiAppLibDestructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
