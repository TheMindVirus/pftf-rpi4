...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdBcm27xxPciRegBase = _PCD_VALUE_PcdBcm27xxPciRegBase;
...
#define _PCD_VALUE_PcdBcm27xxPciBusMmioAdr  0xf8000000ULL
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdBcm27xxPciBusMmioAdr = _PCD_VALUE_PcdBcm27xxPciBusMmioAdr;
...
#define _PCD_VALUE_PcdBcm27xxPciBusMmioLen  0x3ffffffU
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdBcm27xxPciBusMmioLen = _PCD_VALUE_PcdBcm27xxPciBusMmioLen;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdBcm27xxPciCpuMmioAdr = _PCD_VALUE_PcdBcm27xxPciCpuMmioAdr;
  ...
  )
{
  ...
  Status = Bcm2711PciHostBridgeLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
