...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xe2b1eaf3, 0x50b7, 0x4ae1, {0xb7, 0x9e, 0xec, 0x80, 0x20, 0xcb, 0x57, 0xac}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BcmGenetDxe";
...
{
  return GenetEntryPoint (ImageHandle, SystemTable);
}
...
{
  return GenetUnload (ImageHandle);
}
