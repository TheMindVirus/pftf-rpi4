...
#define _PCD_TOKEN_PcdSerialLineControl  0U
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdFdtBaseAddress = _PCD_VALUE_PcdFdtBaseAddress;
...
#define _PCD_TOKEN_PcdNvStorageEventLogSize  0U
