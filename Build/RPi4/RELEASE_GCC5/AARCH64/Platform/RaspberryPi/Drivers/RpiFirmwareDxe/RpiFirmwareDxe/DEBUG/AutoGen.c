...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6d4628df, 0x49a0, 0x4b67, {0xa3, 0x25, 0xd5, 0xaf, 0x35, 0xc6, 0x57, 0x45}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RpiFirmwareDxe";
...
{
  return RpiFirmwareDxeInitialize (ImageHandle, SystemTable);
}
