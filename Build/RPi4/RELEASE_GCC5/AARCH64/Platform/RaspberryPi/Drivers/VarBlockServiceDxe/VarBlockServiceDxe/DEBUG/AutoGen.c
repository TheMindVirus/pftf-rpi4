...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "VarBlockServiceDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdNvStorageVariableBase = _PCD_VALUE_PcdNvStorageVariableBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdNvStorageFtwWorkingBase = _PCD_VALUE_PcdNvStorageFtwWorkingBase;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdNvStorageFtwSpareBase = _PCD_VALUE_PcdNvStorageFtwSpareBase;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdFirmwareBlockSize = _PCD_VALUE_PcdFirmwareBlockSize;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdNvStorageEventLogBase = _PCD_VALUE_PcdNvStorageEventLogBase;
