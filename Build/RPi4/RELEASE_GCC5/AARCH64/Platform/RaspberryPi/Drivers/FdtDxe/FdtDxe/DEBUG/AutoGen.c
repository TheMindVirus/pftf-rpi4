...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8505280f, 0x109e, 0x437e, {0x9f, 0xe4, 0x1a, 0xa0, 0x9c, 0x70, 0x74, 0xd9}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FdtDxe";
...
{
  return FdtDxeInitialize (ImageHandle, SystemTable);
}
