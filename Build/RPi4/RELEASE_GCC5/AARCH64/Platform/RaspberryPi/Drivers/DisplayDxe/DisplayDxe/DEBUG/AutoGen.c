...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xc5deae31, 0xfad2, 0x4030, {0x84, 0x1b, 0xcf, 0xc9, 0x64, 0x4d, 0x2c, 0x5b}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DisplayDxe";
...
{
  return DisplayDxeInitialize (ImageHandle, SystemTable);
}
