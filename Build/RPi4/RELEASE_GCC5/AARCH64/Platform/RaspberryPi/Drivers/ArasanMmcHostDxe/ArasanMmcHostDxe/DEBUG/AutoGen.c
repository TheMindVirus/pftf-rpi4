...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x100c2cfa, 0xb586, 0x4198, {0x9b, 0x4c, 0x16, 0x83, 0xd1, 0x95, 0xb1, 0xda}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ArasanMMCHost";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gRaspberryPiMmcHostProtocolGuid = { 0x3e591c00, 0x9e4a, 0x11df, {0x92, 0x44, 0x00, 0x02, 0xA5, 0xF5, 0xF5, 0x1B } };
...
{
  return MMCInitialize (ImageHandle, SystemTable);
}
