...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4bf1704c, 0x03f4, 0x46d5, {0xbc, 0xa6, 0x82, 0xfa, 0x58, 0x0b, 0xad, 0xfd}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DwUsbHostDxe";
...
{
  return DwUsbHostEntryPoint (ImageHandle, SystemTable);
}
