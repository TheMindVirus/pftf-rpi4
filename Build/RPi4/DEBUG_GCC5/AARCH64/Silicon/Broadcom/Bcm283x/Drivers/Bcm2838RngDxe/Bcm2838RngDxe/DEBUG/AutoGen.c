...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x5ec564ce, 0xb656, 0x435c, {0xa6, 0x52, 0x5c, 0xb7, 0x19, 0x78, 0x45, 0x42}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Bcm2838RngDxe";
...
{
  return Bcm2838RngEntryPoint (ImageHandle, SystemTable);
}
