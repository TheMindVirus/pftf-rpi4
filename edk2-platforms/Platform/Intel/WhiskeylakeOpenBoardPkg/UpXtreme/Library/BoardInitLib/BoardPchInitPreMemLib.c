  ...
  )
{
  ...
  switch (BoardId) {
    ...
    case BoardIdUpXtreme:
      Clock[0].PcieClock.ClockUsage = FREE_RUNNING;
      Clock[1].PcieClock.ClockUsage = FREE_RUNNING;
      Clock[2].PcieClock.ClockUsage = FREE_RUNNING;
      Clock[3].PcieClock.ClockUsage = FREE_RUNNING;
      Clock[4].PcieClock.ClockUsage = FREE_RUNNING;
      Clock[5].PcieClock.ClockUsage = FREE_RUNNING;
      break;
