...
#define RPI_POST_DISPLAY_B2    6
#define RPI_POST_DISPLAY_C2    19
#define RPI_POST_DISPLAY_D2    21
#define RPI_POST_DISPLAY_E2    20
#define RPI_POST_DISPLAY_F2    12
#define RPI_POST_DISPLAY_G2    13

STATIC UINT8 QCODE2DIGIT(UINT8 Q, BOOLEAN DOT)
{
    UINT8 D = 0x0;
         if (Q == 0x0) { D = 0x3F; }
...
STATIC VOID RPiFirmwarePOSTCode(UINT8 qcode)
{
    ...
    GpioPinFuncSet(RPI_POST_DISPLAY_A1, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_B1, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_C1, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_D1, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_E1, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_F1, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_G1, GPIO_FSEL_OUTPUT);
    
    GpioPinFuncSet(RPI_POST_DISPLAY_X2, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_A2, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_B2, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_C2, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_D2, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_E2, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_F2, GPIO_FSEL_OUTPUT);
    GpioPinFuncSet(RPI_POST_DISPLAY_G2, GPIO_FSEL_OUTPUT);

    GpioPinConfigure(RPI_POST_DISPLAY_X1, ((digit1     ) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_A1, ((digit1 >> 1) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_B1, ((digit1 >> 2) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_C1, ((digit1 >> 3) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_D1, ((digit1 >> 4) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_E1, ((digit1 >> 5) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_F1, ((digit1 >> 6) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_G1, ((digit1 >> 7) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);

    GpioPinConfigure(RPI_POST_DISPLAY_X2, ((digit2     ) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_A2, ((digit2 >> 1) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_B2, ((digit2 >> 2) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_C2, ((digit2 >> 3) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_D2, ((digit2 >> 4) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_E2, ((digit2 >> 5) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_F2, ((digit2 >> 6) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
    GpioPinConfigure(RPI_POST_DISPLAY_G2, ((digit2 >> 7) & 1) == 1 ? SET_GPIO : CLEAR_GPIO);
}
